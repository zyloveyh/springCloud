...
public class MysqlGenerator {
    ...
    public static void Generator(String[] tableName) {
        ...
        gc.setOutputDir(projectPath + "/hello-service/src/main/java")
        ...
        dsc.setDbType(DbType.MARIADB)
                .setUrl("jdbc:mysql://192.168.1.4:3306/mybatis?useUnicode=true&characterEncoding=utf8")
        ...
        pc.setParent("com.zy.helloservice")//配置父包路径
                .setModuleName("mp")//配置业务包路径
                .setMapper("mapper")
                .setEntity("entity")
                .setService("service")
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/hello-service/src/main/resources/com/zy/helloservice/" + pc.getModuleName()
